        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <AnimatedSection animation="fade-in-right" delay={300}>
            <div className="relative">
              <div className="bg-[#4caf2f] border-4 border-black shadow-[16px_16px_0px_0px_#000] p-4 md:p-6 transform rotate-2 hover:shadow-[20px_20px_0px_0px_#000] hover:-translate-y-2 transition-all duration-300">
                <Image
                  src="/imagen.JPG"
