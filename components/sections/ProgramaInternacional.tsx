      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {cohorts.map((cohort, index) => (
            <div key={index}>
              <div className="bg-white border-4 border-black shadow-[6px_6px_0px_0px_#000] p-5 md:p-6 h-full hover:shadow-[10px_10px_0px_0px_#000] transition-all duration-300">
