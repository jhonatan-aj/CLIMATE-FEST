        ...
        <AnimatedSection animation="scale-in">
          <div className="bg-[#1e2845] border-4 border-black shadow-[16px_16px_0px_0px_#000] p-6 md:p-8 transform rotate-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#"
                className="bg-[#4caf2f] text-white px-8 md:px-12 py-4 md:py-6 border-4 border-black shadow-[8px_8px_0px_0px_#000] hover:shadow-[12px_12px_0px_0px_#000] hover:-translate-y-1 transition-all font-bold text-lg md:text-xl"
              >
                INSCRÍBETE AHORA
              </a>
              <a
                href="#alianzas"
                className="bg-white text-[#1e2845] px-8 md:px-12 py-4 md:py-6 border-4 border-black shadow-[8px_8px_0px_0px_#000] hover:shadow-[12px_12px_0px_0px_#000] hover:-translate-y-1 transition-all font-bold text-lg md:text-xl"
              >
                SER ALIADO
              </a>
            </div>
